...
public class LocalSkeletonGraphic extends BaseGraphic {
    ...
    public void draw(Canvas canvas) {
        for (int i = 0; i < skeletons.size(); i++) {
            ...
            Log.e("Head:","x="+skeleton.getJointPoint(MLJoint.TYPE_HEAD_TOP).getPointX()+",y="+skeleton.getJointPoint(MLJoint.TYPE_HEAD_TOP).getPointY());
            Log.e("Neck:","x="+skeleton.getJointPoint(MLJoint.TYPE_NECK).getPointX()+",y="+skeleton.getJointPoint(MLJoint.TYPE_NECK).getPointY());
            Log.e("LeftHand:","x="+skeleton.getJointPoint(MLJoint.TYPE_LEFT_WRIST).getPointX()+",y="+skeleton.getJointPoint(MLJoint.TYPE_LEFT_WRIST).getPointY());
            Log.e("RightHand:","x="+skeleton.getJointPoint(MLJoint.TYPE_RIGHT_WRIST).getPointX()+",y="+skeleton.getJointPoint(MLJoint.TYPE_RIGHT_WRIST).getPointY());
            Log.e("LeftFoot:","x="+skeleton.getJointPoint(MLJoint.TYPE_LEFT_ANKLE).getPointX()+",y="+skeleton.getJointPoint(MLJoint.TYPE_LEFT_ANKLE).getPointY());
            Log.e("RightFoot:","x="+skeleton.getJointPoint(MLJoint.TYPE_RIGHT_ANKLE).getPointX()+",y="+skeleton.getJointPoint(MLJoint.TYPE_RIGHT_ANKLE).getPointY());
