        ...
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ...
                    list.add(demoBean.getHeight());
                    list.add(demoBean.getShoulder());
                    list.add(demoBean.getChest());
                    list.add(demoBean.getWaist());
                    list.add(demoBean.getButto());
                    list.add(demoBean.getCrotch());
                    list.add(demoBean.getWatohip());
                    list.add(demoBean.getFrontchest());
                    list.add(demoBean.getArmw());
